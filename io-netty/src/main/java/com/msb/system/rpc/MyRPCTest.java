...
class ClientFactory {   // Singleton
    ...
    public synchronized NioSocketChannel getClient(InetSocketAddress address) {
        ...
        int i = rand.nextInt(poolSize); // 随机取一个client连接
    ...
    private NioSocketChannel create(InetSocketAddress address) {
        ...
        //基于 netty 的客户端创建方式
        clientWorkerGroup = new NioEventLoopGroup(1);
...
class MyContent implements Serializable {
    ...
    String methodName;
    Class<?>[] parameterTypes; // param type of the method
    Object[] args;  // param value of the method
    String res;

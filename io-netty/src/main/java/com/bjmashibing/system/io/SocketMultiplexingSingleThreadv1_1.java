...
/*
在整个单线程的环境下, 如果有某一环的读写处理出现执行缓慢的现象, 就会对整体的性能产生影响
 */
...
//                            key.cancel();
              readHandler(key);  // 只处理了  read  并register 关心这个key的write事件
              System.out.println("get read, register write");
...
//            }
  ...
  public void acceptHandler(SelectionKey key) {
    try {
      ...
      ByteBuffer buffer = ByteBuffer.allocate(8192);  // attachment
  ...
  public static void main(String[] args) {
    final SocketMultiplexingSingleThreadv1_1 service = new SocketMultiplexingSingleThreadv1_1();
    service.start();
  }
}

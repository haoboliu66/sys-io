...
class ServerBootStrap {
    ...
    public void bind(int port) throws IOException {
        ...
        sAcceptr = new ServerAccepter(chiledGroup, server);
        EventLoop eventloop = group.choser();
...
class ServerAccepter implements Handler {
    ...
    public void doRead() {
        try {
            final EventLoop eventLoop = cGroup.choser();
